...
contract TokenManagerBase is ITokenController, IForwarder, AragonApp {
    ...
    string internal constant ERROR_CALLER_NOT_TOKEN = "TM_CALLER_NOT_TOKEN";
    string internal constant ERROR_NO_VESTING = "TM_NO_VESTING";
    string internal constant ERROR_TOKEN_CONTROLLER = "TM_TOKEN_CONTROLLER";
    string internal constant ERROR_MINT_RECEIVER_IS_TM = "TM_MINT_RECEIVER_IS_TM";
    string internal constant ERROR_VESTING_TO_TM = "TM_VESTING_TO_TM";
    string internal constant ERROR_TOO_MANY_VESTINGS = "TM_TOO_MANY_VESTINGS";
    string internal constant ERROR_WRONG_CLIFF_DATE = "TM_WRONG_CLIFF_DATE";
    string internal constant ERROR_VESTING_NOT_REVOKABLE = "TM_VESTING_NOT_REVOKABLE";
    string internal constant ERROR_REVOKE_TRANSFER_FROM_REVERTED = "TM_REVOKE_TRANSFER_FROM_REVERTED";
    string internal constant ERROR_CAN_NOT_FORWARD = "TM_CAN_NOT_FORWARD";
    string internal constant ERROR_BALANCE_INCREASE_NOT_ALLOWED = "TM_BALANCE_INC_NOT_ALLOWED";
    string internal constant ERROR_ASSIGN_TRANSFER_FROM_REVERTED = "TM_ASSIGN_TRANSFER_FROM_REVERTED";
